...
def main():
    ...
    all_data = pickle.load(open("dataset/all_data_wing_noise(SO-smooth(20))_5000.pkl",
                                'rb'))  # 加载自己生成的训练集
    ...
    if args.save_model:
        torch.save(model.state_dict(), f"model_pt/model_noise5000(SO-CNN-SA_smooth(20))_{time_stamp}.pt")
