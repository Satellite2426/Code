...
import numpy as np
from model_CA_output_less import Net
...
if __name__ == '__main__':
    ...
    model.load_state_dict(
        torch.load("model_pt/model_noise5000(SO-CNN-CA(only_output-less)_smooth(20))_2023-07-03_23-21-01.pt"))
    ...
    # df.to_csv('distances(CNN-CA-output-less).csv', index=False)
